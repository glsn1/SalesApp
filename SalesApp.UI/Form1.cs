...
namespace SalesApp.UI
{
	public partial class Form1 : Form
	{
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if(isAdd)
            {
                Order order = new Order(dtpOrderDate.Value,int.Parse(txtQuantity.Text));
            ...
            else
            {
                ...
                order.Customer = customerDAL.Get((int)cbCustomer.SelectedValue);
        ...
        private void değiştirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            cbProduct.Text = dgv.CurrentRow.Cells[1].Value.ToString();
            cbCustomer.Text = dgv.CurrentRow.Cells[2].Value.ToString();
            dtpOrderDate.Value = (DateTime)dgv.CurrentRow.Cells[4].Value;
